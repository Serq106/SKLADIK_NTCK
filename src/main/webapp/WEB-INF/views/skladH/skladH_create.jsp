...
<html>
	...
	<div class="main-sklad">		
		<form class="subform" action="${pageContext.servletContext.contextPath}/skladH/add" method="post">
			<div class="form-center">		
				...
				<p>
					<login for="alt_edin" class="label">альтернативная ед. измерения</login>
